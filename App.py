...
connection = pymysql.connect(host='localhost',user='root',password='',db='analyser')
...
def run():
   ...
   # Connect to the database
    ...
    if choice == 'User':
        ...
        if st.button('Login'):
            if ad_user == 'abcd' and ad_password == 'abc123':
                st.success("Welcome Soundarya Satish Iyer !")
                # Display Data
